  ...
  td.addEventListener("click", () => {
    ...
    if (update_snack) {
      ...
      update_snack.innerHTML = ` 
        ...
        <td class="table-quantity styles table-quantities">${product_containers[drink].quantity}</td>
...
function snack_run(elem) {
  ...
  if (update_snack) {
    ...
    update_snack.innerHTML = ` 
      ...
      <td class="table-quantity styles table-quantities">${product_containers[snack].quantity}</td>
...
add_button.addEventListener("click", () => {
  ...
  if (update_snack) {
    // here there are already an <tr> is avilable so we don't need to create a new row
    update_snack.innerHTML = ` 
      <td class="table-item styles">${random_item}</td>
      <td class="table-quantity styles table-quantities">${product_containers[random_item].quantity}</td>
    ...
    table.innerHTML += ` 
      ...
      <td class="table-item styles">${random_item}</td>
      <td class="table-quantity styles table-quantities
      ">${product_containers[random_item].quantity}</td>
      <td class="table-unitprice styles table-unitprices">${product_containers[random_item].unit_price}</td>
      <td class="table-totalprice styles" id="tprice">${roundoff}</td>
      </tr>`;
  }
